...
function App({ children }: PropsWithChildren) {
    ...
    async function checkAuthentication() {
        try {
            ...
            if (!token) {
                setIsLoading(false);
                return; // ✅ Do NOT force redirect here (Let Next.js handle 404)
            }
    ...
    useEffect(() => {
        checkAuthentication(); // ✅ Only runs once on mount
    }, []);

    return (
        <div className={`w-screen h-screen flex flex-col overflow-hidden ${themeConfig.menu}`}>
