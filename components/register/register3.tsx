...
function RegisterComponent3() {
  ...
  const fullText =
    "We regret to inform you that, after careful consideration, we areunable to proceed with your onboarding at this time. We appreciate the effort you put into the interview process and encourage you to stay connected for future opportunities. Thank you for your understanding.";
