...
const AgreementComponent = () => {
  ...
  const downloadPDF = async () => {
    ...
    setIsDownloading(true); // Hide "Clear Signature" button before capturing
    ...
    setTimeout(async () => {
      ...
      setIsDownloading(false); // Show "Clear Signature" button again after download
    }, 500);
  };
  ...
  return (
    <div className="flex flex-col items-center w-full">
      {/* Agreement Container */}
      <div
        className="bg-white shadow-lg rounded-lg p-6 md:p-12 text-gray-800 max-w-[900px] w-full"
        ref={agreementRef}
      >
        {/* Header */}
        ...
        {[
          {
            ...
            content: [
              ...
              "Avoid any actions or disclosures that may harm the Company's reputation or competitive position.",
            ],
          },
          {
        ...
        <div className="flex flex-col md:flex-row justify-between mt-6 md:mt-8 text-sm md:text-lg font-semibold">
          ...
          <div className="w-full md:w-1/2 mt-4 md:mt-0">
            ...
            {/* Hide Clear Signature Button While Downloading */}
            {!isDownloading && (
      ...
      {/* Buttons Section */}
      <div className="flex justify-between mt-8 w-full max-w-[900px]">
        <button onClick={downloadPDF} className="w-[48%] py-2 px-4 bg-[#FFCD66] text-white font-inter rounded-lg shadow-lg">
          Download Agreement
        </button>
        <button onClick={handleSignOut} className="w-[48%] py-2 px-4 bg-[#FFCD66] text-white font-inter rounded-lg shadow-lg">
          Sign Out
        </button>
      </div>
    </div>
