...
import Step1Form from '@/components/auth/cover-register/components-auth-register-page1';
...
const CoverRegister = () => {
    ...
    return (
        ...
        style={{
            ...
            <div className="relative flex w-full max-w-[667px] flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 mt-12 sm:px-6">
            <div className="w-full max-w-[440px] lg:mt-16 flex flex-col items-center justify-center transform translate-y-[-10%]">
                ...
                {/* <p className="absolute bottom-0 w-full text-center md:bottom-25 dark:text-white">
